...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col lg:flex-row overflow-hidden relative bg-[#FAF8F5]">
      {/* Vertical side text — marca de lujo */}
      <div className="hidden xl:flex items-center absolute left-6 top-1/2 -translate-y-1/2 z-10">
        <p
          className="text-[9px] tracking-[0.5em] uppercase text-neutral-400 font-inter whitespace-nowrap"
          style={{ writingMode: "vertical-rl", transform: "rotate(180deg)" }}
        >
          Especialista Jerarquizada · Bahía Blanca · Argentina
        </p>
      </div>
        ...
        <div className="max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-[#1A0F18] text-white px-8 py-4 text-[11px] tracking-[0.22em] uppercase font-inter hover:bg-rose-950 transition-all duration-300 group"
            >
      ...
      <div className="w-full lg:w-[42%] xl:w-[38%] bg-[#F0E6EC] relative flex items-center justify-center min-h-[55vh] lg:min-h-screen order-1 lg:order-2 overflow-hidden">
        <div className="absolute top-0 right-0 w-3/4 h-3/4 bg-rose-200/25 rounded-bl-[300px] pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-1/2 h-1/3 bg-rose-200/20 rounded-tr-[200px] pointer-events-none" />

        <div className="relative z-10 flex flex-col items-center">
          <div className="w-52 h-52 md:w-72 md:h-72 rounded-full bg-white/60 border-2 border-rose-200 flex items-center justify-center shadow-sm">
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-max max-w-[calc(100%-3rem)]">
          <div className="bg-white/80 backdrop-blur-sm px-8 py-4 shadow-sm border border-rose-100">
